...
{
   /// <summary>
   /// Business Object para Consultas a la Tabla: RH_DiaDescanso (RH_DiaDescanso)
   /// </summary>
   public class DiaDescanso : BusinessObjectBase, IBOQuery
   {
      ...
      public DataTable GetByCriteria(IEntityBase value)
      {
         ...
         IDOQuery objData = (IDOQuery)new RHDOQry.DiaDescanso();
