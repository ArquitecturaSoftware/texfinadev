...
{
    /// <summary>
    /// Business Object para Consultas a la Tabla: Proceso de Planilla (RH_ProcPlani)
    /// </summary>
    public class ProcPlani : BusinessObjectBase, IBOQuery
    {
        ...
        public DataTable GetByCriteria(IEntityBase value)
        {
            ...
            IDOQuery objData = (IDOQuery)new RHDOQry.ProcPlani();
