...
{
    /// <summary>
    /// Business Object para Consultas a la Tabla: RH_PerVacaProv (RH_PerVacaProv)
    /// </summary>
    public class PerVacaProv : BusinessObjectBase, IBOQuery
    {
        ...
        public DataTable GetByCriteria(IEntityBase value)
        {
            ...
            IDOQuery objData = (IDOQuery)new RHDOQry.PerVacaProv();
