...
{
   /// <summary>
   /// Business Object para Consultas a la Tabla: RH_ProcPlaHora (RH_ProcPlaHora)
   /// </summary>
   public class ProcPlaHora : BusinessObjectBase, IBOQuery
   {
      ...
      public DataTable GetByCriteria(IEntityBase value)
      {
         ...
         IDOQuery objData = (IDOQuery)new RHDOQry.ProcPlaHora();
