...
{
   /// <summary>
   /// Data Object para consultas a la Tabla SY_Usuario
   /// </summary>
   /// <remarks></remarks>
   public class Usuario : DataObjectBase, IDOQuery
   {
      ...
      public IEntityBase GetByKey(IEntityBase value)
      {
         ...
         try
         {
            ...
            DataTable dt = this.ExecuteDatatable("SY_Usuario_qry02", arrPrm);

            objE = null;

            foreach (DataRow dr in dt.Rows)
               objE = DataHelper.CopyDataRowToEntity<EUsuario>(dr, typeof(EUsuario));
      ...
      public DataTable GetByParentKey(IEntityBase value)
      {
         ...
         try
         {
            ...
            DataTable dt = this.ExecuteDatatable("SY_Usuario_qry03", arrPrm);
      ...
      public DataTable GetList(IEntityBase value)
      {
         ...
         try
         {
            ...
            DataTable dt = this.ExecuteDatatable("SY_Usuario_qry04", arrPrm);
      ...
      public bool Exists(IEntityBase value)
      {
         ...
         try
         {
            ...
            DataTable dt = this.ExecuteDatatable("SY_Usuario_qry05", arrPrm);
