...
namespace Sist_Compras
{
    public partial class FrmProducto_qry : Form
    {
        ...
        private void ListarProducto()
        {
            try
            {
                ...
                if (psintypesel == 1)
                {
                    ...
                    DataSet ds = BProducto.GetListFill(prod);
        ...
        //string prod, codigo, idpre,pres, unid, idtg, dstg;
        //decimal pesobruto;

        //private void dgproducto_KeyUp(object sender, KeyEventArgs e)
        //{
        ...
        //private void dgproducto_KeyPress(object sender, KeyPressEventArgs e)
        //{
