...
namespace Texfina.Core.Common
{
   public class ConstSistema
   {
      ...
      public static readonly string LOGO_WEBPAGE = "wfLogo.aspx";
   ...
   public class ConstSessionVar
   {
      ...
      public static readonly string ocPERIODO = "_ocPERIODO";

      public static readonly string USERNAME = "_USERNAME"; 
      ...
      public static readonly string IDLOGON = "_IDLOGON";
