...
{
    /// <summary>
    /// Data Object para Consultas a la Tabla: RH_PerVacaProv (RH_PerVacaProv)
    /// </summary>
    /// <remarks></remarks>
    public class PerVacaProv : DataObjectBase, IDOQuery
    {
        ...
        public DataTable GetByCriteria(IEntityBase value)
        {
            ...
            try
            {
                ...
                DataTable dt = this.ExecuteDatatable("RH_PerVacaProv_qry01", arrPrm);
        ...
        public IEntityBase GetByKey(IEntityBase value)
        {
            ...
            try
            {
                ...
                DataTable dt = this.ExecuteDatatable("RH_PerVacaProv_qry02", arrPrm);

                objE = null;

                foreach (DataRow dr in dt.Rows)
                    objE = DataHelper.CopyDataRowToEntity<EPerVacaProv>(dr, typeof(EPerVacaProv));
        ...
        public DataTable GetByParentKey(IEntityBase value)
        {
            ...
            try
            {
                ...
                DataTable dt = this.ExecuteDatatable("RH_PerVacaProv_qry03", arrPrm);
        ...
        public DataTable GetList(IEntityBase value)
        {
            ...
            try
            {
                ...
                DataTable dt = this.ExecuteDatatable("RH_PerVacaProv_qry04", arrPrm);
        ...
        public bool Exists(IEntityBase value)
        {
            ...
            try
            {
                ...
                DataTable dt = this.ExecuteDatatable("RH_PerVacaProv_qry05", arrPrm);
