...
{
    /// <summary>
    /// Business Object para Consultas a la Tabla: RH_TRegistro (RH_TRegistro)
    /// </summary>
    public class Sunat : BusinessObjectBase, IBOQuery
    {
        ...
        public DataTable GetByCriteria(IEntityBase value)
        {
            ...
            IDOQuery objData = (IDOQuery)new CODOQry.Sunat();
