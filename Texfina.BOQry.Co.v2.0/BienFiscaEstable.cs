...
using CODOQry = Texfina.DOQry.Co;

namespace Texfina.BOQry.Co
{

    /// <summary>
    /// Business Object para Consultas a la Tabla: CO_BienFiscaEstable (CO_BienFiscaEstable)
    /// </summary>
    public class BienFiscaEstable : BusinessObjectBase, IBOQuery
    {
        ...
        public DataTable GetByCriteria(IEntityBase value)
        {
            ...
            IDOQuery objData = (IDOQuery)new CODOQry.BienFiscaEstable();
